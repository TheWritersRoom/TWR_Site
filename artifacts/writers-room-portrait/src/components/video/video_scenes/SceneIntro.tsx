    ...
    >
      ...
      <div style={{ fontFamily: 'var(--font-display)', overflow: 'hidden', lineHeight: 1, marginBottom: '0.5vh' }}>
        {'The'.split('').map((ch, i) => (
          <motion.span
            key={i}
            style={{ display: 'inline-block', fontSize: '6vh', fontWeight: 900, color: '#F9F6EE', letterSpacing: '-0.02em' }}
            initial={{ opacity: 0, y: '1em', rotateX: -40 }}
            animate={phase >= 2 ? { opacity: 1, y: 0, rotateX: 0 } : { opacity: 0, y: '1em', rotateX: -40 }}
            transition={{ type: 'spring', stiffness: 350, damping: 26, delay: phase >= 2 ? i * 0.04 : 0 }}
          >{ch}</motion.span>
        ))}
      </div>
      ...
      <div style={{ fontFamily: 'var(--font-display)', overflow: 'hidden', lineHeight: 1, marginBottom: '0.5vh' }}>
        {'Writers'.split('').map((ch, i) => (
          <motion.span
            key={i}
            style={{ display: 'inline-block', fontSize: '12vh', fontWeight: 900, color: '#E8B84B', letterSpacing: '-0.03em' }}
            initial={{ opacity: 0, y: '1em', rotateX: -40 }}
            animate={phase >= 2 ? { opacity: 1, y: 0, rotateX: 0 } : { opacity: 0, y: '1em', rotateX: -40 }}
            transition={{ type: 'spring', stiffness: 350, damping: 26, delay: phase >= 2 ? (3 + i) * 0.04 : 0 }}
          >{ch}</motion.span>
        ))}
      </div>
      ...
      <div style={{ fontFamily: 'var(--font-display)', overflow: 'hidden', lineHeight: 1, marginBottom: '4vh' }}>
        {'Room'.split('').map((ch, i) => (
          <motion.span
            key={i}
            style={{ display: 'inline-block', fontSize: '12vh', fontWeight: 900, color: '#F9F6EE', letterSpacing: '-0.03em' }}
            initial={{ opacity: 0, y: '1em', rotateX: -40 }}
            animate={phase >= 2 ? { opacity: 1, y: 0, rotateX: 0 } : { opacity: 0, y: '1em', rotateX: -40 }}
            transition={{ type: 'spring', stiffness: 350, damping: 26, delay: phase >= 2 ? (10 + i) * 0.04 : 0 }}
          >{ch}</motion.span>
        ))}
      </div>
