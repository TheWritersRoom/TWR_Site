    ...
    >
      ...
      <motion.div
        style={{
          borderRadius: '3vh',
          overflow: 'hidden',
          boxShadow: '0 30px 80px rgba(0,0,0,0.75), 0 0 0 1px rgba(232,184,75,0.25), 0 0 60px rgba(232,184,75,0.09)',
          marginBottom: '4vh',
          flexShrink: 0,
        }}
      ...
      >
        <img
          ...
          style={{ display: 'block', width: '72vmin', height: '72vmin', objectFit: 'cover' }}
        />
      </motion.div>
