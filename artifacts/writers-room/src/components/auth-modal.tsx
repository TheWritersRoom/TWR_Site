                ...
                >
                  ...
                  <div className="flex flex-col gap-2 mb-5">
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-3 h-11 rounded-xl bg-white hover:bg-gray-50 text-[#1A1614] text-sm font-semibold border border-gray-300 transition-colors shadow-sm"
                    >
                    ...
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-3 h-11 rounded-xl bg-[#1877F2] hover:bg-[#1565d8] text-white text-sm font-semibold transition-colors"
                    >
