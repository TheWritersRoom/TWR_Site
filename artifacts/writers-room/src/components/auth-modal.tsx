              ...
              {mode === "signin" && (
                ...
                >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-3 w-full h-12 rounded-xl border-2 border-input bg-background/50 hover:bg-background hover:border-primary/40 transition-all text-sm font-semibold text-foreground"
                  >
