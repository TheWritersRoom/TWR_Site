    ...
    <div className="min-h-screen bg-[#F9F6EE] text-[#1A1614] overflow-x-hidden font-sans">
        ...
        <div className="px-6 md:px-14 py-2 flex items-center justify-between">
          <div className="hidden md:flex items-center gap-6">
            {["Authors", "Contributors", "Discover", "Pitches"].map((item) => (
              <span key={item} className="text-[11px] uppercase tracking-[0.16em] text-[#1A1614] font-semibold hover:text-[#E8A0B4] transition-colors cursor-default">{item}</span>
            ))}
          </div>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="text-[11px] uppercase tracking-[0.16em] font-semibold text-[#1A1614] hover:text-[#E8A0B4] transition-colors"
            >
              Sign in
            </button>
            <button
              onClick={openAuthModal}
              className="px-4 py-1.5 bg-[#1A1614] text-[#F9F6EE] text-[11px] uppercase tracking-[0.16em] font-bold hover:bg-[#E8A0B4] transition-colors"
            >
              Subscribe
            </button>
          </div>
      ...
      <section className="pt-[9.5rem] pb-0 min-h-screen flex flex-col">
        ...
        <div className="bg-[#E8B84B] px-6 md:px-14 pt-14 pb-16 flex-1 flex flex-col items-center justify-center text-center relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-1.5 bg-[#E8A0B4]" />
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                onClick={openAuthModal}
                className="flex items-center gap-2 px-8 py-3.5 bg-[#1A1614] text-[#F9F6EE] text-sm font-bold uppercase tracking-[0.12em] hover:bg-[#E8A0B4] transition-colors"
              >
          ...
          {/* Bottom teal accent */}
          <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-[#E8A0B4]" />
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-0">
            {FEATURES.map((f, i) => (
              ...
              >
                <div className="w-8 h-8 rounded-sm bg-[#E8A0B4]/20 text-[#E8A0B4] flex items-center justify-center mb-4 group-hover:bg-[#E8B84B]/20 group-hover:text-[#E8B84B] transition-colors">
                  {f.icon}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-0 border-2 border-[#1A1614]">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-[#E8A0B4] flex items-center justify-center text-white">
              ...
              <ul className="space-y-3 mb-8">
                {FOR_AUTHORS.map((item) => (
                  <li key={item} className="flex items-start gap-3 text-sm text-[#1A1614]">
                    <Check className="w-4 h-4 text-[#E8A0B4] shrink-0 mt-0.5" />
                    {item}
                  </li>
                ))}
              </ul>
              <button
                onClick={openAuthModal}
                className="w-full py-3 bg-[#1A1614] text-[#F9F6EE] font-bold text-xs uppercase tracking-[0.14em] hover:bg-[#E8A0B4] transition-colors"
              >
      ...
      {/* ── CTA BANNER ── */}
      <section className="py-24 px-6 md:px-14 bg-[#E8A0B4] text-[#F9F6EE]">
