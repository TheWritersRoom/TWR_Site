...
/* Persistent layer data keyed by scene index */
const BLOB1 = [
  { x: '50%', y: '40%', scale: 3.2 },
  { x: '80%', y: '22%', scale: 2.0 },
  { x: '18%', y: '78%', scale: 2.2 },
...
const LINE_LEFT   = ['50%', '6vw',  '52vw', '6vw',  '52vw', '6vw',  '52vw', '30vw'];
const LINE_WIDTH  = ['0px', '24vw', '22vw', '24vw', '22vw', '24vw', '22vw', '40vw'];
const LINE_OPACITY = [0, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.5];

const FLOAT_X = ['48vw', '8vw', '88vw', '10vw', '86vw', '10vw', '88vw', '48vw'];
const FLOAT_Y = ['14vh', '72vh', '18vh', '20vh', '74vh', '22vh', '70vh', '14vh'];
const FLOAT_R = [0, 45, 90, 135, 180, 225, 270, 360];
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden" style={{ background: '#1A1614' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Continuously drifting ambient circle */}
        <motion.div
          className="absolute rounded-full pointer-events-none"
          style={{
            width: '30vw',
      ...
      <motion.div
        ...
        animate={{
          ...
          opacity: sceneIndex === 0 || sceneIndex === 7 ? 0 : 0.7,
        }}
        transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
      />

      {/* Second ornament — smaller, opposite corner */}
      <motion.div
        className="absolute pointer-events-none"
        style={{
          width: '1.2vw',
        ...
        animate={{
          ...
          top: FLOAT_X[(sceneIndex + 4) % 8],
          opacity: sceneIndex === 7 ? 0 : 0.5,
          scale: [1, 1.3, 1],
        }}
        transition={{
