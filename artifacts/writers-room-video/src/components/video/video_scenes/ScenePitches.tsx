...
export function ScenePitches() {
  ...
  return (
    <motion.div
      ...
      initial={{ opacity: 0, rotateX: -8, transformPerspective: 1400 }}
      animate={{ opacity: 1, rotateX: 0, transformPerspective: 1400 }}
    ...
    >
      ...
      >
        ...
        >
          <img
            src={`${import.meta.env.BASE_URL}images/05-pitches-board.jpg`}
            alt="Open Pitches"
